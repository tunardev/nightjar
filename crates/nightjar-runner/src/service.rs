...
const UNSUPPORTED_PLATFORM: &str = "a nightjar service can only be installed on macOS and Linux";

/// # Errors
/// fails off macOS and Linux, or if a path is not utf-8 or cannot be shell-quoted
...
/// # Errors
/// fails off macOS and Linux, or if no override root is given and `HOME` is unset
...
/// # Errors
/// fails for the reasons `install_root_from` does
